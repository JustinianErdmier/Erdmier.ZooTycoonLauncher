...
/// <summary>Resolves on-disk paths the launcher reads and writes (SDD §4.7).</summary>
/// <remarks>
///     All paths are absolute. Implementations may compute paths from <c>%LOCALAPPDATA%</c> or, in tests, from a temp directory; the application layer must not depend on either
///     resolution strategy.
/// </remarks>
