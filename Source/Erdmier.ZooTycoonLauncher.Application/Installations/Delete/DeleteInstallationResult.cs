...
/// <param name="NewDefaultInstallationId">
///     When <see cref="RemovedWasDefault" /> is <see langword="true" />, the id of the promoted replacement, or <see langword="null" /> when no
