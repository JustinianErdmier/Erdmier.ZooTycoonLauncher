...
/// <summary>
///     Points an existing installation at a new folder, recomputes <c>HasExe</c> / <c>HasIni</c>, and stamps <c>ModifiedUtc</c>. Implements SDD §7.2.5 for the EXE-relocation
///     case.
/// </summary>
