...
public sealed class NoGameInstallationFoundViewModel : ViewModelBase
{
    /// <summary>Initialises a new instance.</summary>
    /// <param name="locatedCandidatePath">
    ///     The path discovered by <c>IInstallationLocator</c>, or <see langword="null" /> when nothing was found or the state was reached without running
    ///     the locator.
    /// </param>
    public NoGameInstallationFoundViewModel(string? locatedCandidatePath) => LocatedCandidatePath = locatedCandidatePath;
