...
/// <summary>
///     The main window's view model. In this foundation milestone it only carries a placeholder banner string; subsequent milestones replace the banner with the state-dispatch
///     surface specified by SDD §9.2.
/// </summary>
