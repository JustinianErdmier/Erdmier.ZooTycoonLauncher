...
/// <summary>Represents a Zoo Tycoon installation tracked by the launcher.</summary>
/// <remarks>
///     Identity is the <see cref="Id" /> Guid (Version 7) set by the application layer at creation time. <see cref="Path" /> is <see langword="init" />-only — relocating an
///     installation rewrites the row in place rather than as a separate entity.
/// </remarks>
