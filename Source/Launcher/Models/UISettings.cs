...
/// <summary>
///     Strongly typed representation of the <c> [UI] </c> section of <c> zoo.ini </c>. Covers audio, gameplay (cash), interface, and miscellaneous runtime-state keys.
/// </summary>
