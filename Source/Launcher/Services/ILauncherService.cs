...
public interface ILauncherService
{
    ...
    /// <returns>
    ///     <see cref="LaunchResult.Success" /> = <see langword="true" /> on a successful <c>Process.Start</c>; otherwise the failure is captured in
    ///     <see cref="LaunchResult.ErrorMessage" /> rather than thrown.
    /// </returns>
