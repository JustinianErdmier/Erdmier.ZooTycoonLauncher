...
public sealed class WindowsShellService : IShellService
{
    ...
    public void RevealInExplorer(string? path)
    {
        ...
        {
            // Defensive: an exotic Windows install without explorer.exe on PATH would throw. Swallow rather than crashing the launcher — the worst case is a click that does
