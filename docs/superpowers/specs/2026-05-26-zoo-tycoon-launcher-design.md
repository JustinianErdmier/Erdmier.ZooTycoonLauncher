...
| DW-12 | UAC VirtualStore redirection of `zoo.ini` — candidate future slice; see §14.5 row 9.                                                                             | INI Config core spec |
